...
// ─── Apps pool ───────────────────────────────────────────────────────────────
const ALL_APPS: Array<{ name: string; icon: React.ComponentProps<typeof MaterialIcons>["name"]; category: string }> = [
...
function DurationCard({
  ...
  return (
    <Animated.View style={[animated, { width }]}>
      <TouchableOpacity
        style={[
          styles.durationCard,
      ...
      >
        ...
        <Text style={[styles.durationHint, { color: isActive ? "rgba(255,255,255,0.6)" : colors.outlineVariant ?? "#c6c6c6" }]}>
          {option.hint}
        </Text>
      </TouchableOpacity>
    </Animated.View>
...
export default function FocusScreen() {
  ...
  const pillW = (SCREEN_W - 40 - 12 * 3) / 4;
    ...
    <View style={[styles.root, { backgroundColor: colors.background }]}>
      ...
      >
        ...
        >
          ...
          {showCustom && (
            <Animated.View
              entering={isWeb ? undefined : FadeInDown.duration(200).springify()}
              style={[styles.customInputRow, { backgroundColor: colors.card }]}
            >
              <TextInput
                ref={customRef}
        ...
        >
          ...
          {blockedApps.length === 0 ? (
            ...
            >
              ...
              <Text style={[styles.emptyAppsTitle, { color: colors.onSurface }]}>
                No apps blocked
              </Text>
            ...
            <View style={[styles.appsCard, { backgroundColor: colors.card }]}>
              {ALL_APPS.filter((a) => blockedApps.includes(a.name)).map((app, i, arr) => (
                <View
                  ...
                  style={[
                    styles.appRow,
                    i < arr.length - 1 && { marginBottom: 14 },
                  ]}
                >
